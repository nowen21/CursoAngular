...
import { AfterContentInitGrandchildComponent } from '../after-content-init-grandchild/after-content-init-grandchild.component';
...
export class AfterContentInitChildComponent {
  ...
  @ContentChild(AfterContentInitGrandchildComponent) contentChild!: AfterContentInitGrandchildComponent;
